...
- [austinlparker/otel-mcp](https://github.com/austinlparker/otel-mcp) - an experimental mcp extension and connector for the opentelemetry collector
- [liatrio-labs/otel-instrumentation-mcp](https://github.com/liatrio-labs/otel-instrumentation-mcp) - A MCP for instrumenting applications with OpenTelemetry.
- [mottibec/otelcol-mcp](https://github.com/mottibec/otelcol-mcp) - The OTEL MCP Server
- [pavolloffay/opentelemetry-mcp-server](https://github.com/pavolloffay/opentelemetry-mcp-server) - Model Context Protocol (MCP) Server for OpenTelemetry to enable your LLM be an OTEL expert.
...
- [krzko/run-with-telemetry](https://github.com/krzko/run-with-telemetry) - 🏃🏻‍♂️‍➡️ GitHub Action `run` action with OpenTelemetry instrumentation

### Visualization & Dashboards
- [jack5341/otelmap](https://github.com/jack5341/otelmap) - Open-source service map visualization tool that generates service dependency maps from OpenTelemetry trace data.
